...
$projectsTexts2 = $languageArray['project page']['under dot texts'][0];
$projectsMainText = $languageArray['project page']['main texts'][0];
$projImage = "../../img/proj1.jpg";
...
<?php
    $numberOfDeepnes = 2;
    $hrefs = array("../../home","../projectsPg", "./berth-7");
