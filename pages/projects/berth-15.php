...
$projImage = "../../img/proj2.jpg";
$projectsTexts1 =  $languageArray['project page']['dot texts'];
$projectsTexts2 = $languageArray['project page']['under dot texts'][1];
$projectsMainText = $languageArray['project page']['main texts'][1];

?>

<?php
    $numberOfDeepnes = 2;
    $hrefs = array("../../home","../projectsPg", "./berth-15");
    $titles = $languageArray['small menu berth-15'];
    include "../../reusable/smallMenu.php";
    ?>
<div class="title_of_page dfjcac container <?php echo $languageArray['font-family'][0] ?>"><?php echo $languageArray['project page']['titles'][1] ?></div>
