    ...
    <div class="header_cont container dfjbac pt1 pb1">
        ...
        <div class="lg_menu dfjcac gap3">
            ...
            <div class="lg_menu_company dfjcac m1 usn p1 pr ">
                <span class="lg_menu_item <?php echo $languageArray['font-family'][0] ?>"><?php echo $languageArray['company'] ?></span><i class="ml1 fa-solid fa-angle-down lg_menu_expand_icon lg_menu_company_arr td"></i>
            ...
            <div class="lg_menu_sector dfjcac m1 usn p1 pr ">
                <span class="lg_menu_item <?php echo $languageArray['font-family'][0] ?>"><?php echo $languageArray['sectors title'] ?></span><i class="ml1 fa-solid fa-angle-down lg_menu_expand_icon lg_menu_sector_arr td"></i>
        ...
        <div class="lan_and_search_wrapper dfjcac gap4">
            ...
            <div class="lan dn">
                <div class="usn p1 dfjcac">
                    <div class="dfjcac tac <?php echo $languageArray['font-family'][0] ?>"><?php echo $languageArray['language'] ?></div>
                    <i class="ml1 fa-solid fa-angle-down ml1"></i>
                </div>
